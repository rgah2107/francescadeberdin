...
export const en: Dictionary = {
  heroAlt:
    "Francesca de Bardin, author of Moscow Diary, seated beside the book. She is an American living in Moscow.",
  ...
  buyCta: {
    title: "The rest is in the diary",
    text: "Meet Francesca here. Then let her walk you through the Moscow she actually lives in.",
    button: "Buy the book",
    secondary: "About the book",
  },
  retailers: [{ id: "amazon", label: "Buy from Amazon" }],
  notFound: {
    title: "This page is not here",
    text: "The author, and the door into her book, are still on the home page.",
    home: "Return home",
  },
  home: {
    metaTitle: "Francesca de Bardin | Moscow Diary, an American in Moscow",
    metaDescription:
      "Francesca de Bardin is an American writer living in Moscow and the author of Moscow Diary, her firsthand story of daily life, culture, food, and the city.",
    crumb: "Home",
    ...
    hooks: [
      {
        title: "Two words",
        text: "She reached Moscow able to say yes and no. Everything that followed — the help, the mistakes, the affection — is the story.",
      },
      {
        title: "The question",
        text: "Why would an American live here? She is asked it in shops, in taxis, and at dinner. She stopped answering in passing. She answered in a book.",
      },
      {
        title: "The distance",
        text: "Between the country described in the West and the country she inhabits. She invites you to walk it with her, at the length of a book.",
      },
    ],
    videoTitle: "She tells it herself",
    videoText: "Francesca speaks about what living in Moscow has been like for her.",
  },
  about: {
    metaTitle: "About Francesca de Bardin, American Writer in Moscow",
    metaDescription:
      "The life behind Moscow Diary: San Francisco, three decades as a New York entrepreneur, a marriage in Paris, and the choice, in 2022, to live in Russia.",
    crumb: "The Author",
    eyebrow: "The author",
    title: "The woman who chose Moscow",
    lead: "Readers who like a memoir usually want to know who is speaking before they want to know the plot. Francesca de Bardin is a San Francisco-born American, a French citizen by marriage and by years, and a resident of Moscow by a decision she is still glad to explain.",
    timelineTitle: "A life in four cities",
    timeline: [
      {
        when: "San Francisco",
  ...
  book: {
    metaTitle: "Moscow Diary by Francesca de Bardin",
    metaDescription:
      "Moscow Diary is Francesca de Bardin’s personal story of living in Russia: culture, food, places, and the welcome an American found in Moscow. Published in 2024.",
    crumb: "The Book",
    eyebrow: "The book",
    title: "Moscow Diary",
    ...
    reviews: [
      {
        name: "James K.",
        rating: 5,
        title: "Positive perspective by an American living in Moscow",
        text: "This book is an easy read and provides information, history and a positive perspective on Russia and its people. It is an interesting contrast to what is in the US news on a daily basis. I recommend this book to learn more about life in Russia today.",
        date: "2024-10-27",
        place: "United States",
      },
      {
        name: "Macho333",
        rating: 4,
        title: "Life in Moscow today",
        text: "A very readable view of life in Moscow for an American. Good insight into the average Russian of today by a very bright and observant American transplant. Ms. Bardin has lived in Los Angeles, Paris and now resides in Moscow. I gained valuable knowledge about a country which most Americans know little. Very worth a read.",
        date: "2024-10-14",
        place: "United States",
      },
      {
        name: "Neato burrito",
        rating: 5,
        title: "Great read! Thank you",
        text: "I really enjoyed the book! It is full of great information for those interested in going to or living in Moscow. From simple every day struggles to Russian history, I enjoyed it all. The help she received from strangers was surprising, in a good way! I hope that one day we also will have stories like this to tell.",
        date: "2026-09-11",
        place: "United States",
      },
      {
        name: "Natalia",
        rating: 5,
        title: "Fresh unbiased perspective and fun read",
        text: "Fun, honest and open minded",
        date: "2026-09-10",
        place: "United States",
      },
      {
        name: "Adam Toews",
        rating: 5,
        title: "Import reference book for Russia.",
        text: "Excellent read! Very informative book!",
        date: "2026-09-21",
        place: "Canada",
      },
    ],
  ...
  faq: {
    ...
    items: [
      ...
      {
        id: "why-read",
        question: "Why read it instead of another book about Russia?",
        answer:
          "Because the author pays rent there. She is not passing through on a panel, and she is not summarizing someone else’s reporting. If you want to know what living in Russia has felt like to a widely traveled American woman who is glad she came, this is her voice, at eye level.",
      },
      {
        id: "politics",
  ...
  buy: {
    ...
    lead: "Take the diary home. It is Francesca de Bardin’s own story of choosing Moscow, and of the life, the culture, and the city she wants you to see for yourself.",
  ...
  contact: {
    ...
    metaDescription:
      "Write to Francesca de Bardin. Leave your email and a message, and it will reach her directly.",
    crumb: "Get in touch",
    eyebrow: "A letter",
    title: "Get in touch",
    lead: "If you have read the diary, or you are about to, you may write to Francesca here. Leave your email and a few words.",
    nameLabel: "Your name",
    emailLabel: "Your email",
    messageLabel: "Your message",
    submit: "Send",
    sending: "Sending",
    success: "Your note is on its way. She will have it in her inbox.",
    error: "The note could not be sent. Please try again in a moment.",
    nameInvalid: "Enter your name.",
    emailInvalid: "Enter an email address she can reply to.",
    messageInvalid: "Write a message before sending.",
  },
  related: {
    about: ["book", "buy"],
    book: ["about", "buy"],
